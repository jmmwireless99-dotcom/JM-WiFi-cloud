(function () {
  ...
  const views = {
    ...
    'hotspot-vendo': 'Operations · ALL VENDO · Hotspot Vendo',
    'vlan-detail': 'Operations · ALL VENDO · Hotspot Vendo · VLAN',
    'empty-bottle': 'Operations · ALL VENDO · Empty Bottle Vendo',
